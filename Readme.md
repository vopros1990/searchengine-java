...
- [Подключение модуля Lucene Morphology](#подключение-модуля-lucene-morphology)
...
_Более ранние версии компонентов не тестировались_    
...
* *Введите имя базы данных mySQL, имя пользователя и пароль в соответствующие поля* *
...
```
____
## Подключение модуля Lucene Morphology
Для работы модуля морфологического анализа нужно вручную подключить
библиотеки Lucene Morphology
Для этого просто скачайте файлы по [ССЫЛКЕ](https://drive.google.com/file/d/1t5bfxfJKq0xdKS9ZbfIrA8gTojCD5neJ/view?usp=sharing).
Затем распакуйте содержимое архива (6 папок) в каталог:
`src/main/resources/lemmatizer`    
#### ⬆️  [НАВЕРХ](#search-engine-java)
____
...
Работа модуля поиска тесно связана с синтаксисом mySQL, однако, прии желани,
можно использовать более гибкую и функциональную PostgreSQL

### Модуль формирования снипетта найденной страницы
